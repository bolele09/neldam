                    ...
                    <div class="menu-full-width">
                        ...
                        <div class="main-menu-content">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="#"><span class="la la-home"></span>Accueil</a>
                                    ...
                                    <li>
                                        <a href="#"><span class="la la-la la-cutlery
"></span>categories </a>
                                        <!-- <ul class="dropdown-menu-item">
    ...
    <div class="side-nav-container">
        ...
        <div class="side-menu-wrap">
            <ul class="side-menu-ul">
                <li>
                   ...
                   <!--  <ul class="dropdown-menu-item">
                        ...
                        <li><a href="menuresto.php">Restaurants </a></li>
                        <li><a href="index3.html">home three</a></li>
                     <li><a href="index4.html">home four <span class="new-page-badge">new</span></a></li>
                        <li><a href="index5.html">home five <span class="new-page-badge">new</span></a></li>                   
                      </ul> --> 
                ...
                <li>
                    <a href="#">Restaurants <span class="la la-angle-down"></span></a>
                   <!--  <ul class="dropdown-menu-item">
                        <li><a href="all-categories.html">all categories</a></li>
                        <li><a href="all-locations.html">all locations</a></li>
                        <li><a href="top-place.html">top places </a></li>
            ...
            <div class="side-nav-button">
                <a href="login.html" class="theme-btn">Se connecter</a>
                <a href="sign-up.html" class="theme-btn">S'inscrire</a>
    ...
    <div class="side-user-panel">
        ...
        <div class="side-menu-wrap side-user-menu-wrap">
            <div class="side-user-img">
                <img src="images/neldam.jpeg" alt="image">
...
================================= -->
<div class="enttes">
     <img class="photent" src="restaurant.jpg" width="100%" height="100%">
</div>
