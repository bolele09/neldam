...
?>
<h1 class="Style3" align="center"> Mofifier un compte </h1>
<form action="modifcompte.php" method="post" class="container">
  <table width="430" border="0" align="center">
    <tr>
      ...
      <td width="267"><label>
        <input name="oldlog" type="text" size="30" class="info"  required placeholder="Ancien Login"/>
        </label></td>
    </tr>
    <tr>
      <td class="etiquette"><div align="left"><strong>Ancien mot de passe </strong></div></td>
      <td><label>
        <input name="oldpwd" type="text" size="30" class="info" required placeholder="Ancien mot de passe"/>
        </label></td>
    </tr>
    <tr>
      <td class="etiquette"><div align="left"><strong>Nouveau login </strong></div></td>
      <td><label>
        <input name="newlog" type="text" size="30" class="info" required placeholder="Nouveau login"/>
        </label></td>
    </tr>
    <tr>
      <td class="etiquette"><div align="left"><strong>Nouveau mot de passe </strong></div></td>
      <td><label>
        <input name="newpwd" type="text" size="30" class="info" required placeholder="Nouveau mot de passe"/>
        </label></td>
    </tr>
    <tr>
      <td class="etiquette"><div align="left"><strong>Confirmation</strong></div></td>
      <td><label>
        <input name="conf" type="text" size="30" class="info" required placeholder="confirmation"/>
        </label></td>
    </tr>
    <tr>
      <td colspan="2"><label>
